...
#r7:checked~.panels>#panel7,#r6:checked~.panels>#panel6,#r5:checked~.panels>#panel5,#r4:checked~.panels>#panel4,#r1:checked~.panels>#panel1,#r3:checked~.panels>#panel3,#r2:checked~.panels>#panel2{display:block}\
#r7:checked~.tabs>#tab7,#r6:checked~.tabs>#tab6,#r5:checked~.tabs>#tab5,#r4:checked~.tabs>#tab4,#r1:checked~.tabs>#tab1,#r3:checked~.tabs>#tab3,#r2:checked~.tabs>#tab2{background:#438DBF;color:#fff}";
...
const char WEB_PAGE_FOOTER[] PROGMEM = "<br/><br/>"
		...
		"&copy; AirCarto</a>&nbsp;&nbsp("
                "<a href='https://github.com/aircarto/NebuloLED/labels/bug' target='_blank' rel='noreferrer'>" INTL_REPORT_ISSUE "</a>"
