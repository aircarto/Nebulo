...
namespace cfg
{
	...
	void initNonTrivials(const char *id)
	{
		...
		strcpy_P(appeui, APPEUI_String);
		strcpy_P(deveui, DEVEUI_String);
		strcpy_P(appkey, APPKEY_String);
...
// APPEUI en LSB
static const u1_t PROGMEM APPEUI[8] = {0x55, 0x34, 0x42, 0x33, 0x12, 0x33, 0x87, 0x77};
void os_getArtEui(u1_t *buf) { memcpy_P(buf, APPEUI, 8); }

// DEVEUI en LSB
static const u1_t PROGMEM DEVEUI[8] = {0x2B, 0xAF, 0x04, 0xD0, 0x7E, 0xD5, 0xB3, 0x70};
void os_getDevEui(u1_t *buf) { memcpy_P(buf, DEVEUI, 8); }

// APPKEY en MSB
static const u1_t PROGMEM APPKEY[16] = {0xC2, 0x1B, 0x47, 0xF7, 0x7E, 0x35, 0x0C, 0xFC, 0xB0, 0x10, 0xC3, 0x2F, 0xD3, 0xC0, 0x95, 0x69};
...
// #if defined (ESP32) and not defined(ARDUINO_HELTEC_WIFI_LORA_32_V2)
